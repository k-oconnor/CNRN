...
class TARNRNModule(nn.Module):
    ...
    def __init__(
        ...
        """
        super(TARNRNModule, self).__init__()
    ...
    def forward(self, x: torch.Tensor):
        ...
        # Average across internal head channels as in the original causal TARNet path.
