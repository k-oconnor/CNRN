...
class PruningReasoningNetworkModel(ReasoningNetworkModel):
    ...
    def perform_prune(self) -> None:
        ...
        """
        # Abstract method to be implemented by subclasses (see BaseBanditNRNModel.perform_prune)
        raise NotImplementedError("perform_prune must be implemented by subclasses")
