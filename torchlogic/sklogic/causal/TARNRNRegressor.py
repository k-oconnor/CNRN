...
import pandas as pd
import torch
from torchlogic.sklogic.causal.tar_module import TARNet
...
class TARNRNRegressor(BaseSKLogicEstimator):
    @staticmethod
    ...
    def __init__(
        ...
        # Robust scaling is less sensitive to outliers and preserves ordering.
    ...
    def fit(self, X: pd.DataFrame, y: pd.DataFrame, propensity_scores=None) -> None:
        ...
        dataset = CausalDataset(X_arr, t_arr, y_arr, g=g_arr)
