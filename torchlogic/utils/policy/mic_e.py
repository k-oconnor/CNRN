...
## Getting lazy in the home stretch. I asked claude to wrap everything up in a single function so we can run all cov at once, and output the desired matrix
## Implementation is a bit verbose, but it handles both single covariate MIC and pairwise MIC matrix computation.
